...
public enum SaladType {
	...
	PUMPKIN_PIE("pumpkin_pie_salad", effect(CobbleCuisineEffects.TIMID.entry)),
	...
	SNOW_CLOAK_CAESAR("snow_cloak_caesar_salad", effect(CobbleCuisineEffects.BASHFUL.entry)),
